...
let g:pdv_cfg_Package = "default"
let g:pdv_cfg_Version = "v1.0"
let g:pdv_cfg_Copyright = "2006-2013 V"
let g:pdv_cfg_License = "PHP Version 3.0 {@link http://www.php.net/license/3_0.txt}"
"let g:pdv_cfg_Author = "yangqing <yangqing@ucfgroup.com>"
...
func! PhpDocFunc()
    ...
    exe l:txtBOL . g:pdv_cfg_Commentn . "Date: " . strftime("%Y-%m-%d") . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Commentn . "Created by " . g:pdv_cfg_Author . g:pdv_cfg_EOL
...
func! PhpDocClass()
    ...
    let namespace_pos = search('^namespace\s', 'n')
    if !empty(namespace_pos)
        let g:pdv_cfg_Package=substitute(getline(namespace_pos), '^namespace\s\+\(.*\);$', '\1', "g")
        if !empty(g:pdv_cfg_Package)
